...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate, AddDeviceViewControllerDelegate {
    ...
    func showAddDeviceViewController(vc: UIViewController, sender: AnyObject?) {
        let addDeviceViewController = AddDeviceViewController()
        addDeviceViewController.modalPresentationStyle = .OverCurrentContext
     ...
     */
    func deleteDeviceAtIndex(rowIndex: NSIndexPath) {
        let context = self.fetchedResultsController.managedObjectContext
        context.deleteObject(self.fetchedResultsController.objectAtIndexPath(rowIndex) as! NSManagedObject)
